...
/**
 * Provides the local service interface for Draw. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author A.Galdos
 * @see DrawLocalServiceUtil
...
public interface DrawLocalService extends BaseLocalService, InvokableLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DrawLocalServiceUtil} to access the draw local service. Add custom service methods to {@link net.sareweb.emg.service.impl.DrawLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
