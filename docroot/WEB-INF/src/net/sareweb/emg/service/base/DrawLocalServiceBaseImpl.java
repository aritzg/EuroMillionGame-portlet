...
import net.sareweb.emg.service.DrawLocalService;
...
/**
 * Provides the base implementation for the draw local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.sareweb.emg.service.impl.DrawLocalServiceImpl}.
 * </p>
 *
 * @author A.Galdos
 ...
 * @generated
 */
public abstract class DrawLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements DrawLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link net.sareweb.emg.service.DrawLocalServiceUtil} to access the draw local service.
	 */
	...
	@Override
	public Draw addDraw(Draw draw) throws SystemException {
		draw.setNew(true);

		return drawPersistence.update(draw);
	}
	 ...
	 */
	@Override
	public Draw createDraw(long drawId) {
		return drawPersistence.create(drawId);
	}
	...
	@Override
	public Draw deleteDraw(long drawId) throws PortalException, SystemException {
		return drawPersistence.remove(drawId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Draw deleteDraw(Draw draw) throws SystemException {
		return drawPersistence.remove(draw);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Draw.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return drawPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return drawPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return drawPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return drawPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Draw fetchDraw(long drawId) throws SystemException {
		return drawPersistence.fetchByPrimaryKey(drawId);
	}
	 ...
	 */
	@Override
	public Draw getDraw(long drawId) throws PortalException, SystemException {
		return drawPersistence.findByPrimaryKey(drawId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return drawPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Draw> getDraws(int start, int end) throws SystemException {
		return drawPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDrawsCount() throws SystemException {
		return drawPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Draw updateDraw(Draw draw) throws SystemException {
		return drawPersistence.update(draw);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("net.sareweb.emg.model.Draw",
			drawLocalService);
	}
	...
	private DrawLocalServiceClpInvoker _clpInvoker = new DrawLocalServiceClpInvoker();
}